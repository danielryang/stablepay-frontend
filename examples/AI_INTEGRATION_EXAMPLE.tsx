...
import { enhanceRecommendationWithAI, generateAISummary } from "@/utils/aiEnhancer";
    ...
    return (
        <View>
            ...
            {aiEnhanced?.recommendations?.map((rec: any, idx: number) => (
                <View
                    key={idx}
                    style={{ margin: 16, padding: 16, backgroundColor: "#FFF", borderRadius: 8 }}
                >
                    ...
                    {rec.aiExplanation && (
                        ...
                        >
                            ...
                            <Text style={{ fontSize: 14 }}>{rec.aiExplanation}</Text>
                        </View>
                    )}
...
export function PortfolioQABot({ results, userBalances }: any) {
    ...
    return (
        <View style={{ padding: 16 }}>
            <Text style={{ fontWeight: "bold", marginBottom: 8 }}>💬 Ask about your portfolio</Text>
            <TextInput
                value={question}
